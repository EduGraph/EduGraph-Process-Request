...
import org.camunda.bpm.engine.runtime.Execution;
	  ...
	  public class SendChangeDeny implements JavaDelegate{
		  ...
		  public void execute(DelegateExecution arg0) throws Exception {
			  ...
			  email.setMsg("Guten Tag "+ arg0.getVariable("customerName")+", Es tut uns Leid Ihnen mitteilen zu müssen, dass die " + arg0.getVariable("customerRequest") + "-Anfrage leider vom Team abgewählt wurde.");
			  email.send();
		  }
	  }
