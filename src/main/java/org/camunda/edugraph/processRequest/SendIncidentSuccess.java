...
import org.camunda.bpm.engine.runtime.Execution;
	  ...
	  public class SendIncidentSuccess implements JavaDelegate{
		  ...
		  public void execute(DelegateExecution arg0) throws Exception {
			  ...
			  email.setMsg("Guten Tag "+ arg0.getVariable("customerName")+", Die " + arg0.getVariable("customerRequest") + "-Anfrage wurde behoben.");
			  email.send();
		  }
	  }
